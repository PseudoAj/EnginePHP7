...
///home/domain
$engineVars['baseRoot']      = dirname(dirname(dirname(dirname(EngineAPI::$engineDir)))); #"/home/library";
...
$engineVars['tempDir']       = dirname(dirname(EngineAPI::$engineDir)) ."/template";
...
$engineVars['fileListings']  = dirname(dirname(EngineAPI::$engineDir))."/filelistings";

// phpMailing Include
$engineVars['emailInclude']  = dirname(dirname(EngineAPI::$engineDir)) ."/phpmailer/phpmailer-fe.php";

// less compiler include
$engineVars['lessHandler'] = dirname(dirname(EngineAPI::$engineDir)) ."/lessc/lessc.inc.php";
